...
class ChangeRecordWindow(QWidget):
    def __init__(self, main):
        ...
        self.pushButton.clicked.connect(self.ButtonChange)
        self.pushButton_2.clicked.connect(self.ButtonChange)
    ...
    def ButtonChange(self):
        self.main.pushButton_10.setStyleSheet("background-color:white;")
...
class AddRecordWindow(QWidget):
    ...
    def closeEvent(self, event):
        ...
        event.accept()
    def ButtonChange(self):
        self.main.maintable.pushButton_6.setStyleSheet("background-color:white;")
    def OpenContract(self):
        file , check = QFileDialog.getOpenFileName(None, "QFileDialog.getOpenFileName()", "", "Text files (*.pdf *.txt *docx)")
        self.label_10.setText(file)
...
class ChangeUnitWindow(QWidget):
    ...
    def closeEvent(self, event):
        ...
        event.accept()
    def ButtonChange(self):
        self.main.pushButton_4.setStyleSheet("background-color:white;")
    def LoadData(self,id):
        self.id_order = id
        connection = sqlite3.connect(GlobalPath.path_data_base)
        now_cursor = connection.cursor()
...
class AddUnitWindow(QWidget):
    ...
    def ButtonChange(self):
        self.main.pushButton.setStyleSheet("background-color:white;")
