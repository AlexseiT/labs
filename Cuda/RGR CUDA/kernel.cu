...
int main()
{
    ...
    cudaMemcpy(device_input_matrix_1, input_matrix_1, NUM_ELEMENTS * sizeof(float),
        cudaMemcpyHostToDevice);
    cudaMemcpy(device_input_matrix_2, input_matrix_2, NUM_ELEMENTS * sizeof(float),
        cudaMemcpyHostToDevice);
    ...
    cudaMemcpy(output_matrix, device_output_matrix, NUM_ELEMENTS * sizeof(float),
    ...
    elapsed_time_kernel_matrix_multiplication = kernel_matrix_multiply(device_input_matrix_1,
        device_input_matrix_2, device_output_matrix);
    cudaMemcpy(output_matrix, device_output_matrix, NUM_ELEMENTS * sizeof(float),
        cudaMemcpyDeviceToHost);
    ...
    elapsed_time_thrust_matrix_multiplication = thrust_matrix_multiply(device_input_matrix_1,
        device_input_matrix_2, device_output_matrix);
    cudaMemcpy(output_matrix, device_output_matrix, NUM_ELEMENTS * sizeof(float),
        cudaMemcpyDeviceToHost);
    multiply_check(input_matrix_1, input_matrix_2, output_matrix);
    ...
    elapsed_time_cublas_matrix_multiplication = cublas_matrix_multiply(device_input_matrix_1,
        device_input_matrix_2, device_output_matrix);
    cudaMemcpy(output_matrix, device_output_matrix, NUM_ELEMENTS * sizeof(float),
        cudaMemcpyDeviceToHost);
    multiply_check(input_matrix_1, input_matrix_2, output_matrix);
    ...
    elapsed_time_kernel_scalar_multiplication = kernel_scalar_multiply(device_input_matrix_1,
        device_output_matrix);
    cudaMemcpy(output_matrix, device_output_matrix, NUM_ELEMENTS * sizeof(float),
        cudaMemcpyDeviceToHost);
    ...
    elapsed_time_thrust_scalar_multiplication = thrust_scalar_multiply(device_input_matrix_1,
        device_output_matrix);
    cudaMemcpy(output_matrix, device_output_matrix, NUM_ELEMENTS * sizeof(float),
        cudaMemcpyDeviceToHost);
    scalar_check(input_matrix_1, output_matrix);
    ...
    elapsed_time_cublas_scalar_multiplication = cublas_scalar_multiply(device_input_matrix_1,
        device_output_matrix);
    cudaMemcpy(output_matrix, device_output_matrix, NUM_ELEMENTS * sizeof(float),
        cudaMemcpyDeviceToHost);
    scalar_check(input_matrix_1, output_matrix);
    ...
    cout << "MATRIX SIZE = " << MATRIX_SIZE << " x " << MATRIX_SIZE << " (" <<
        NUM_ELEMENTS << " elements)" << endl;
    cout << setw(40) << "raw CUDA, ms" << setw(15) << "Thrust, ms"
        << setw(15) << "cuBLSAS, ms" << endl;
    cout << fixed;
    cout << setw(25) << "Matrix transposing" << setw(15) << elapsed_time_kernel_transpose << setw(15) <<
        elapsed_time_thrust_transpose << setw(15) << elapsed_time_cublas_transpose << endl;
    cout << setw(25) << "Matrix multiplication" << setw(15) << elapsed_time_kernel_matrix_multiplication <<
        setw(15) << elapsed_time_thrust_matrix_multiplication << setw(15) <<
        elapsed_time_cublas_matrix_multiplication << endl;
    cout << setw(25) << "Scalar multiplication" << setw(15) << elapsed_time_kernel_scalar_multiplication <<
        setw(15) << elapsed_time_thrust_scalar_multiplication << setw(15) <<
        elapsed_time_cublas_scalar_multiplication << endl;
    ...
    if (FILE_OUTPUT)
    {
        ...
        file << MATRIX_SIZE << ";"
            << elapsed_time_kernel_transpose << ";" << elapsed_time_thrust_transpose << ";" <<
            elapsed_time_cublas_transpose << ";"
            << elapsed_time_kernel_matrix_multiplication << ";" << elapsed_time_thrust_matrix_multiplication
            << ";" << elapsed_time_cublas_matrix_multiplication << ";"
            << elapsed_time_kernel_scalar_multiplication << ";" << elapsed_time_thrust_scalar_multiplication
            << ";" << elapsed_time_cublas_scalar_multiplication << ";"
            << endl;
